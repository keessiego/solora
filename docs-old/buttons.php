        ...
        <div class="w-full flex flex-col">
          ...
          <section class="mx-8">
            ...
            <div class="flex flex-row justify-between">
              <button class="btn-primary btn-sm" onclick="window.location.href = 'install.php'">< Vorige</button>
              <button class="btn-primary btn-sm" onclick="window.location.href = 'codeblock.php'">Volgende ></button>
            </div>
          </section>
        </div>
